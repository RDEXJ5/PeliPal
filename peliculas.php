    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4">
            ...
            <div class="d-flex justify-content-between mb-3">
                <a href="FormInsertar\regPeli.php" class="btn btn-success">Agregar Nuevo</a>
            </div>
        ...
        $sql = "SELECT peliculas.id, peliculas.titulo, generos.nombre AS genero, clasificaciones.nombre AS clasificacion
        FROM peliculas
        INNER JOIN generos ON peliculas.idGeneros = generos.id
        INNER JOIN clasificaciones ON peliculas.idClasificacion = clasificaciones.id";
        ...
        if (mysqli_num_rows($resultado) > 0) {
            ...
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>
                        ...
                        <td>
                            <form action='FormActualizar/formPeli.php' method='get' class='d-inline'>
