<!DOC            <!-- Botón para abrir el modal de nuevo registro -->
...
<body>
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4">
            ...
            <div class="d-flex justify-content-between mb-3">
                <a href="FormInsertar\regFuncion.php" class="btn btn-success">Agregar Nuevo</a>
            </div>
        ...
        $sql = "SELECT funciones.id, funciones.horaInicio, funciones.horaFin, funciones.dia, peliculas.titulo AS idPelicula, salas.nombre AS idSala
        FROM funciones 
        INNER JOIN peliculas ON funciones.idPelicula = peliculas.id 
        INNER JOIN salas ON funciones.idSala = salas.id";
        ...
        if (mysqli_num_rows($resultado) > 0) {
            ...
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>
                        ...
                        <td>{$fila['idSala']}</td>
                        <td>
                            <form action='FormActualizar/formFun.php' method='get' class='d-inline'>
