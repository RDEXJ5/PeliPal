        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4">
                ...
                <div class="d-flex justify-content-between mb-3">
                    <a href="FormInsertar\regClasificacion.html" class="btn btn-success">Agregar Nuevo</a>
                </div>

                <?php
                $conn = mysqli_connect("localhost", "root", "", "cine")
                    or die("<div class='alert alert-danger text-center'>La conexión falló: " . mysqli_connect_error() . "</div>");
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($fila = mysqli_fetch_assoc($resultado)) {
                        echo "<tr>
                                ...
                                <td>{$fila['nombre']}</td>
                                <td>
                                    <form action='FormActualizar/formClasif.php' method='get' class='d-inline'>
