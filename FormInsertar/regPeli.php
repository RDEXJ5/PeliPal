    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4">
      <div class="card shadow-sm mx-auto" style="max-width: 700px;">
        <div class="card-header bg-primary text-white d-flex align-items-center">
          ...
          <h5 class="mb-0">Registro de Películas</h5>
        </div>

        <div class="card-body">
            <form action="phpInsertar/gdPeli.php" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <select id="genero" name="d2" class="form-select" required>
                ...
                <div class="mb-3">
                  ...
                  <select id="sala" name="d3" class="form-select" required>
